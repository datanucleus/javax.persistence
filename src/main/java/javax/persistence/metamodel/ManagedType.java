...
/**
 * Instances of the type <code>ManagedType</code> represent entity, mapped superclass, and embeddable types.
...
public interface ManagedType<X> extends Type<X>
{
    ...
    /**
     * Return the attributes declared by the managed type. Returns empty set if the managed type has no
     * declared attributes.
    ...
    /**
     * Return the single-valued attribute of the managed type that corresponds to the specified name and Java
     * type.
     * @param name the name of the represented attribute
     * @param type the type of the represented attribute
     * @return single-valued attribute with given name and type
     * @throws IllegalArgumentException if attribute of the given name and type is not present in the managed
     * type
     * @param <Y> Type
     */
     ...
     * @throws IllegalArgumentException if attribute of the given name and type is not declared in the managed
     * type
     * @param <Y> Type
     */
    ...
    /**
     * Return the single-valued attributes declared by the managed type. Returns empty set if the managed type
     * has no declared single-valued attributes.
     * @return declared single-valued attributes
     */
    Set<SingularAttribute<X, ?>> getDeclaredSingularAttributes();

    /**
     * Return the Collection-valued attribute of the managed type that corresponds to the specified name and
     * Java element type.
     * @param name the name of the represented attribute
    ...
    /**
     * Return the Collection-valued attribute declared by the managed type that corresponds to the specified
     * name and Java element type.
     * @param name the name of the represented attribute
     * @param elementType the element type of the represented attribute
     * @return declared <code>CollectionAttribute</code> of the given name and element type
     * @throws IllegalArgumentException if attribute of the given name and type is not declared in the managed
     * type
     * @param <E> Element Type
     */
    ...
    /**
     * Return the Set-valued attribute of the managed type that corresponds to the specified name and Java
     * element type.
     * @param name the name of the represented attribute
     * @param elementType the element type of the represented attribute
    ...
    /**
     * Return the Set-valued attribute declared by the managed type that corresponds to the specified name and
     * Java element type.
     * @param name the name of the represented attribute
     * @param elementType the element type of the represented attribute
    ...
    /**
     * Return the List-valued attribute of the managed type that corresponds to the specified name and Java
     * element type.
     * @param name the name of the represented attribute
     * @param elementType the element type of the represented attribute
    ...
    /**
     * Return the Map-valued attribute of the managed type that corresponds to the specified name and Java key
     * and value types.
     * @param name the name of the represented attribute
    ...
    /**
     * Return the Map-valued attribute declared by the managed type that corresponds to the specified name and
     * Java key and value types.
     * @param name the name of the represented attribute
     * @param keyType the key type of the represented attribute
     * @param valueType the value type of the represented attribute
    ...
    /**
     * Return all multi-valued attributes (Collection-, Set-, List-, and Map-valued attributes) of the managed
     * type. Returns empty set if the managed type has no multi-valued attributes.
     * @return Collection-, Set-, List-, and Map-valued attributes
     */
    Set<PluralAttribute<? super X, ?, ?>> getPluralAttributes();

    /**
     * Return all multi-valued attributes (Collection-, Set-, List-, and Map-valued attributes) declared by
     * the managed type. Returns empty set if the managed type has no declared multi-valued attributes.
