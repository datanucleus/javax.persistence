...
public interface IdentifiableType<X> extends ManagedType<X>
{
     ...
     * @return id attribute
     * @throws IllegalArgumentException if id attribute of the given type is not present in the identifiable
     * type or if the identifiable type has an id class
     * @param <Y> Type
     */
     ...
     * @throws IllegalArgumentException if id attribute of the given type is not declared in the identifiable
     * type or if the identifiable type has an id class
     * @param <Y> Type
     */
     ...
     * @throws IllegalArgumentException if version attribute of the given type is not present in the
     * identifiable type
     * @param <Y> Type
     */
     ...
     * @throws IllegalArgumentException if version attribute of the type is not declared in the identifiable
     * type
     * @param <Y> Type
     */
    ...
    /**
     * Whether the identifiable type has a single id attribute. Returns true for a simple id or embedded id;
     * returns false for an idclass.
