...
public interface PersistenceUnitInfo
{
    ...
    /**
     * Returns the transaction type of the entity managers created by the <code>EntityManagerFactory</code>.
     * The transaction type corresponds to the <code>transaction-type</code> attribute in the
     * <code>persistence.xml</code> file.
     ...
     * to the <code>jta-data-source</code> element in the <code>persistence.xml</code> file or is provided at
     ...
     * outside a JTA transaction. The data source corresponds to the named <code>non-jta-data-source</code>
     * element in the <code>persistence.xml</code> file or provided at deployment or by the container.
     ...
     * <code>jar-file</code> element in the <code>persistence.xml</code> file. A URL will either be a file:
     ...
     * managed classes. Each name corresponds to a named <code>class</code> element in the
     * <code>persistence.xml</code> file.
     ...
     * validation mode corresponds to the <code>validation-mode</code> element in the
     * <code>persistence.xml</code> file.
