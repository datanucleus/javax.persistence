 ...
 * of the <code>Column</code> annotation. In the case of a basic type, the column name is derived from the
 ...
 * <ul>
 * <li>To override the default properties of the column used for a basic type, the <code>Column</code>
 * annotation is used on the collection-valued attribute in addition to the <code>ElementCollection</code>
 * annotation.
 * <li>To override these defaults for an embeddable class, the <code>AttributeOverride</code> and/or
 * <code>AttributeOverrides</code> annotations can be used in addition to the <code>ElementCollection</code>
 ...
 * <code>AssociationOverride</code> and/or <code>AssociationOverrides</code> annotations.
 * </ul>
 * <p>
 * If the <code>CollectionTable</code> annotation is missing, the default values of the
 * <code>CollectionTable</code> annotation elements apply.
 *
 * <pre>
 *    Example:
 * 
...
public @interface CollectionTable
{
     ...
     * <code>JoinColumn</code> (i.e., the concatenation of the following: the name of the entity; "_"; the
     * name of the referenced primary key column.) However, if there is more than one join column, a
     * <code>JoinColumn</code> annotation must be specified for each join column using the
     * <code>JoinColumns</code> annotation. In this case, both the <code>name</code> and the
     * <code>referencedColumnName</code> elements must be specified in each such <code>JoinColumn</code>
     * annotation.
     * @return join columns
     */
