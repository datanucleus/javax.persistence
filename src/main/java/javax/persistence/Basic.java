...
public @interface Basic
{
     ...
     * eagerly fetched. The <code>EAGER</code> strategy is a requirement on the persistence provider runtime
     * that the value must be eagerly fetched. The <code>LAZY</code> strategy is a hint to the persistence
     * provider runtime. If not specified, defaults to <code>EAGER</code>.
     * @return fetch type
     */
    FetchType fetch() default EAGER;

    /**
     * (Optional) Defines whether the value of the field or property may be null. This is a hint and is
     * disregarded for primitive types; it may be used in schema generation. If not specified, defaults to
     * <code>true</code>.
     * @return whether it is optional
     */
