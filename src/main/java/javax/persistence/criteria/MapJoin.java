...
/**
 * The <code>MapJoin</code> interface is the type of the result of joining to a collection over an association
 * or element collection that has been specified as a <code>java.util.Map</code>.
...
public interface MapJoin<Z, K, V> extends PluralJoin<Z, Map<K, V>, V>
{
     ...
     * @return metamodel type representing the <code>Map</code> that is the target of the join
     */
