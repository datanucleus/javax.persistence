...
/**
 * The <code>SetJoin</code> interface is the type of the result of joining to a collection over an association
 * or element collection that has been specified as a <code>java.util.Set</code>.
...
public interface SetJoin<Z, E> extends PluralJoin<Z, Set<E>, E>
{
     ...
     * @return metamodel type representing the <code>Set</code> that is the target of the join
     */
