...
public interface AbstractQuery<T> extends CommonAbstractCriteria
{
    ...
    /**
     * Modify the query to restrict the query results according to the specified boolean expression. Replaces
     * the previously added restriction(s), if any.
    ...
    /**
     * Modify the query to restrict the query results according to the conjunction of the specified
    ...
    /**
     * Specify the expressions that are used to form groups over the query results. Replaces the previous
     * specified grouping expressions, if any. If no grouping expressions are specified, any previously added
     * grouping expressions are simply removed.
    ...
    /**
     * Specify a restriction over the groups of the query. Replaces the previous having restriction(s), if
     * any.
     * @param restriction a simple or compound boolean expression
     * @return the modified query
     */
    ...
    /**
     * Specify restrictions over the groups of the query according the conjunction of the specified
     * restriction predicates. Replaces the previously added having restriction(s), if any. If no restrictions
     * are specified, any previously added restrictions are simply removed.
     * @param restrictions zero or more restriction predicates
     * @return the modified query
     */
     ...
     * @param distinct boolean value specifying whether duplicate results must be eliminated from the query
    ...
    /**
     * Return the query roots. These are the roots that have been defined for the <code>CriteriaQuery</code>
     * or <code>Subquery</code> itself, including any subquery roots defined as a result of correlation.
     * Returns empty set if no roots have been defined. Modifications to the set do not affect the query.
    ...
    /**
     * Return a list of the grouping expressions. Returns empty list if no grouping expressions have been
     * specified. Modifications to the list do not affect the query.
     * @return the list of grouping expressions
     */
    List<Expression<?>> getGroupList();

    /**
     * Return the predicate that corresponds to the restriction(s) over the grouping items, or null if no
     * restrictions have been specified.
     ...
     * createQuery or subquery method, that type will be returned. If the query was created using the
     * createTupleQuery method, the result type is Tuple. Otherwise, the result type is Object.
     * @return result type
     */
