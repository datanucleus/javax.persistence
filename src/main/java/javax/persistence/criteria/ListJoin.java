...
/**
 * The <code>ListJoin</code> interface is the type of the result of joining to a collection over an
 * association or element collection that has been specified as a <code>java.util.List</code>.
...
public interface ListJoin<Z, E> extends PluralJoin<Z, List<E>, E>
{
     ...
     * @return metamodel type representing the <code>List</code> that is the target of the join
     */
