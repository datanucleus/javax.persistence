...
/**
 * The <code>PluralJoin</code> interface defines functionality that is common to joins to all collection
 * types. It is not intended to be used directly in query construction.
