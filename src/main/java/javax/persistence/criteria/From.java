...
public interface From<Z, X> extends Path<X>, FetchParent<Z, X>
{
    ...
    /**
     * Whether the <code>From</code> object has been obtained as a result of correlation (use of a
     * <code>Subquery</code> <code>correlate</code> method).
     * @return boolean indicating whether the object has been obtained through correlation
     */
    boolean isCorrelated();

    /**
     * Returns the parent <code>From</code> object from which the correlated <code>From</code> object has been
     * obtained through correlation (use of a <code>Subquery</code> <code>correlate</code> method).
     * @return the parent of the correlated From object
     * @throws IllegalStateException if the From object has not been obtained through correlation
     */
