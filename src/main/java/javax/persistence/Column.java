...
/**
 * Is used to specify the mapped column for a persistent property or field. If no <code>Column</code>
 * annotation is specified, the default values apply. <blockquote>
 * 
 * <pre>
 *    Example 1:
 * 
